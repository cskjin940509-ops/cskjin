...
def main():
    ...
    live={
        ...
        'stocks':{c:overlay.get(c) for c in codes if overlay.get(c)},
    ...
    print(json.dumps({'yunaiProduction':{'connected':status_ok,'symbols':len(codes),'quoteAvailable':quote_ok,'capitalResponseAvailable':cap_ok}},ensure_ascii=False))
